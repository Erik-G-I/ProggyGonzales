...
public class LanguageScreen extends GameScreen {
	...
	public LanguageScreen(MenuPanel panel) {
		this.panel = panel;
		try {
	...
	public void draw(Graphics g2) {
		...
		g2.drawImage(img1, x, panel.tileSize*3, 100, 100, null);
		if (cmd == 0) {
			if(drawNow) {
			g2.drawString(">", 150, panel.tileSize*3+75);
			this.draw(75);
			str = "Enter - to choose";
			g2.drawString(str, 150, panel.tileSize*8);
			}
		}
		
		g2.drawImage(img2, x+500, panel.tileSize*3, 100, 100, null);
		if (cmd == 1) {
			g2.drawString(">", 650, panel.tileSize*3+75);
			this.draw(75);
